...
# redirect_slashes=False prevents Vercel's proxy from conflicting with
# FastAPI's automatic trailing-slash redirects (which cause 307 loops).
app = FastAPI(title="ORCA Relayer & API", version="1.0.0", redirect_slashes=False)
...
# Contacts — now under /api/contacts for consistent Vercel routing
